...
return [
    ...
    'front' => [
        ...
        'comment_pending_approval_message' => 'Благодарим Ви! Вашият коментар е изпратен и очаква одобрение. Той ще се появи публично, след като администратор го одобри, така че може да не се покаже веднага след публикуването.',

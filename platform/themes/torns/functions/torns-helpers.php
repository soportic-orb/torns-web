    ...
    function torns_pricing_plans(): array
    {
        $plans = [
            ...
            'annual' => [
                ...
                'price' => '29,90 €',
                'period' => '/año',
                'description' => 'Acceso anual a todas las funcionalidades Pro.',
                'features' => "Todas las funcionalidades del plan Free\nCentros de trabajo ilimitados\nAceptar turnos ilimitados\nPropuestas de cambios a 3\nRecordatorios de turnos\nNotificar cambios al gestor\nPublicar SOS cambio urgente\nEstadísticas de trabajo\nCompartir calendario de turnos",
            ...
            'copilot' => [
                ...
                'price' => 'Próximamente',
                'period' => '',
                'description' => 'La IA que te ayudará a gestionar tus cambios con tus compañeros. Adicional a la suscripción.',
                'features' => "Cadenas de cambios a 3 y 4 con IA\nSugerencias según tu disponibilidad\nAprende de tus rutinas",
                'badge' => '',
...
if (! function_exists('torns_comparison_data')) {
    ...
    function torns_comparison_data(): array
    {
        ...
        $defaultRows = [
            ['feature' => 'Enfoque', 'torns' => 'App individual: cambios + calendario', 'aturnos' => 'Planificación B2B para empresas', 'shiftool' => 'App individual de cambios de turno', 'supershift' => 'Calendario de turnos personal', 'turnoclip' => 'Calendario personal con tablón de cambios'],
            ['feature' => 'Cambios de turno gestionados entre compañeros', 'torns' => 'yes', 'aturnos' => 'Si la empresa lo habilita', 'shiftool' => 'yes', 'supershift' => 'no', 'turnoclip' => 'yes'],
            ['feature' => 'Calendario multi-centro unificado', 'torns' => 'yes', 'aturnos' => '-', 'shiftool' => 'yes', 'supershift' => 'yes', 'turnoclip' => '-'],
            ['feature' => 'Sin necesidad de que la empresa lo contrate', 'torns' => 'yes', 'aturnos' => 'no', 'shiftool' => 'yes', 'supershift' => 'yes', 'turnoclip' => 'yes'],
            ['feature' => 'Cadenas de cambios a 3-4 con IA (Copilot)', 'torns' => 'yes', 'aturnos' => '-', 'shiftool' => '-', 'supershift' => 'no', 'turnoclip' => '-'],
            ['feature' => 'SOS de cambio urgente al centro', 'torns' => 'yes', 'aturnos' => '-', 'shiftool' => '-', 'supershift' => 'no', 'turnoclip' => '-'],
            ['feature' => 'Notificación automática al gestor de planillas', 'torns' => 'yes', 'aturnos' => 'Validación por admin', 'shiftool' => 'yes', 'supershift' => 'no', 'turnoclip' => 'PDF de entrega manual'],
            ['feature' => 'Sincronización Apple/Google Calendar', 'torns' => 'yes', 'aturnos' => '-', 'shiftool' => '-', 'supershift' => 'Pro', 'turnoclip' => '-'],
            ['feature' => 'Chat individual y grupal', 'torns' => 'yes', 'aturnos' => '-', 'shiftool' => '-', 'supershift' => 'no', 'turnoclip' => '-'],
            ['feature' => 'Idiomas ES / CA / GL / EU', 'torns' => 'yes', 'aturnos' => 'no', 'shiftool' => 'no', 'supershift' => 'no', 'turnoclip' => '-'],
        ];

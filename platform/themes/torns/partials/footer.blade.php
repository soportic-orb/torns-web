            ...
            <div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
                    <div class="lg:col-span-2">
                        <img src="{{ Theme::asset()->url('images/logo.webp') }}" alt="Torns" class="h-8 w-auto" width="152" height="32">
                ...
                <div class="mt-12 flex flex-col gap-4 border-t border-torns-ink/5 pt-6 text-sm text-torns-ink/70 sm:flex-row sm:items-center sm:justify-between">

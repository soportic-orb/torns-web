...
<html {!! Theme::htmlAttributes() !!}>
    <head>
        ...
        <style>
            :root {
                --color-primary: {{ $primaryColor = theme_option('primary_color', '#5869DA') }};
                ...
                <div class="pt-50 pb-50 ">
                    <div class="row mb-20">
                        <div class="col-12 align-self-center main-search-form-cover m-auto">
                            ...
                            <form action="{{ is_plugin_active('blog') ? route('public.search') : '#' }}" data-url="{{ is_plugin_active('blog') ? route('public.ajax.posts.search') : '' }}" class="search-header d-flex blog-posts-search-form" data-bb-toggle="blog-posts-search-form">
                                <div class="input-group w-100">
                                    <input type="text" name="q" class="form-control" placeholder="{{ __('Search stories, places and people') }}" autocomplete="off">
                            ...
                            <div class="blog-posts-search-results mt-30">
